...
- [web](web/main.go) — a small `net/http` web server demonstrating routing, HTML template rendering, and a SQLite-backed user repository wired into request handlers.
